        ...
        <div className="bg-white shadow-md fixed w-full z-50 py-2 lg:py-0 md:py-0">
            <div className="w-full flex items-center justify-between xl:px-80 lg:px-36 md:px-4 px-5">
                ...
                <div className="hidden md:flex items-center space-x-3 py-1">
                    ...
                    <Link href={'/vendor-login'} className="bg-kuduDarkGrey text-white py-2 px-4 rounded-lg">
                        <span className="mr-1 text-sm font-[500]">Auction your product</span>
                    </Link>

                    <Link href={'/vendor-login'} className="bg-kuduOrange text-white py-2 px-6 rounded-lg">
