    ...
    return (
        <div className="bg-white shadow-md fixed w-full z-[90] py-2 lg:py-0 md:py-0">
            <div className="w-full flex items-center justify-between xl:px-80 lg:px-36 md:px-4 px-5">
                ...
                {/* Desktop Navigation */}
                <div className="hidden md:flex items-center space-x-5 py-1">
                    <Link href="/cart" className="flex items-center text-black gap-1">
                        ...
                        <span className="mr-1 text-[13px] mt-1 font-[500]">Cart</span>
                    </Link>

                    <Link href="/messages" className="text-black flex items-center gap-1">
                    ...
                    <a href="#" className="flex items-center text-black gap-1">
                    ...
                    <Link href={'/auction'} className="bg-kuduDarkGrey text-white py-2 px-4 rounded-lg">
                        <span className="mr-1 text-sm font-[500]">Auction</span>
                    </Link>

                    <Link href={'/post-product'} className="bg-kuduOrange text-white py-2 px-6 rounded-lg">
