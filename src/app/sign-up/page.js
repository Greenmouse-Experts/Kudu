...
export default function Login() {
    return (
        <div className="w-full h-full flex bg-kuduLightBlue">
            <div className="w-1/2 h-screen bg-cover bg-signUp-bg lg:flex md:flex hidden flex-col justify-center">
            ...
            <div className='lg:w-1/2 md:w-1/2 w-full flex h-full md:h-screen px-10 flex-col bg-kuduLightBlue justify-center'>
                <div className='pt-5 lg:px-20 md:px-20 flex flex-col gap-3'>
                    ...
                    <div className="mb-4">
                        ...
                        <Input appendIcon="eye-password.png" type="password" background="bg-kuduDarkFade border-transparent" class="px-3 py-3 placeholder-black" placeholder="Password" />
                    </div>
                    ...
                    <button
                        type="submit"
                        className="w-full py-4 px-4 my-2 flex gap-2 justify-center bg-orange-500 hover:bg-orange-600 text-white rounded-lg font-[500] transition-colors"
                    >
                ...
                <div className='flex justify-center mt-4'>
                    <div className='flex flex-col gap-2'>
                        <p className="text-center">
                            <Link href={'/login'} className="text-kuduOrange flex justify-center gap-2">
