...
export default function Login() {
    return (
        <div className="w-full h-full flex bg-kuduLightBlue">
            <div className="w-1/2 h-screen bg-cover fixed bg-signUp-bg lg:flex md:flex hidden flex-col justify-center">
            ...
            <div className='lg:w-1/2 md:w-1/2 w-full lg:ml-[50%] lg:mb-10 flex h-full px-10 flex-col justify-center'>
