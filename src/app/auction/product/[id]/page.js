        ...
        <>
            <div className="w-full flex flex-col h-full bg-kuduLightBlue">
                ...
                <div className="w-full flex flex-col h-full md:gap-10 bg-kuduLightBlue h-full mt-14 md:mt-16">
                    <div className="w-full xl:px-80 lg:pl-44 lg:pr-36 md:px-4 px-5 py-3 md:py-8 bg-white shadow-lg flex">
                    ...
                    <div className="w-full xl:px-80 lg:pl-44 lg:pr-36 md:px-4 px-5 py-3 md:py-0 border-b-2 border-[rgba(204,204,204,1)] flex">
