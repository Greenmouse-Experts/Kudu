                            ...
                            <div className="flex flex-col gap-4">
                                <div className="flex justify-center relative h-[200px]">
                                    ...
                                    <span className="absolute top-1 right-1">
                                        <Badge bgColor={product.status === 'Used' ? 'bg-kuduRed' : 'bg-kuduGreen'} text={product.status}
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    <Button className="w-full py-2 px-4 flex justify-center gap-2 bg-orange-500 hover:bg-orange-600 text-white rounded-lg font-[500] transition-colors">
