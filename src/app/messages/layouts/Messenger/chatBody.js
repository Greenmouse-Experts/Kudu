        ...
        <div className="md:w-[68%] w-full flex flex-col gap-2 mt-[1px] relative border-l-2 overflow-auto">
            ...
            <div className="flex items-center justify-between p-4 border-b-2">
                <div className="flex items-center">
                    ...
                    />
                    <div>
                        <h2 className="text-sm font-[500]">Football Boots</h2>
                        <p className="text-sm font-bold">₦62,500</p>
                    </div>
                </div>
            ...
            >
                {messages.map((message) => (
                    <div
                        key={message.id}
                        className={`flex flex-col ${message.type === "outgoing" ? "items-end" : "items-start"}`}
                    >
                        <div
                            className={`flex items-center gap-2 max-w-xs px-4 py-2 rounded-lg text-sm ${message.type === "outgoing"
                        ...
                        {/* Message Date */}
                        <p className="mt-1 text-xs font-semibold text-gray-500">{message.date}</p>
                    </div>
                ))}
            </div>
