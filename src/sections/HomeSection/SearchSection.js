...
export default function SearchSection() {
    return (
        <div className="relative w-full lg:min-h-[500px] h-[200px] lg:py-10 md:py-10 py-4 lg:mt-10 md:mt-10 mt-14 bg-black">
            <Image
                ...
                <div className="flex w-full sm:w-10/12 md:w-8/12 lg:w-6/12 relative justify-center">
                    ...
                    <div className="flex w-full flex-col gap-5 z-0">
                        ...
                        <div className="flex justify-center w-full">
                            <button className="bg-orange-500 text-white px-4 py-2 lg:w-1/5 md:w-1/5 w-1/3 md:px-6 md:py-3 rounded-md hover:bg-orange-600 transition duration-300">
                                Search
                            </button>
                        </div>
                    </div>
